...
const states=["Maharashtra", "Delhi", "Karnataka", "Gujarat", "Telangana", "Tamil Nadu", "West Bengal", "Rajasthan", "Uttar Pradesh", "Bihar", "Madhya Pradesh", "Andhra Pradesh", "Punjab", "Haryana", "Jammu and Kashmir", "Jharkhand", "Chhattisgarh", "Assam", "Chandigarh", "Odisha", "Kerala", "Uttarakhand", "Puducherry", "Tripura", "Mizoram", "Meghalaya", "Manipur", "Himachal Pradesh", "Nagaland", "Goa", "Andaman and Nicobar Islands", "Arunachal Pradesh", "Dadra and Nagar Haveli", "Himachal Praddesh"];
states.sort();
cities.sort((a,b)=>{
